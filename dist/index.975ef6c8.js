...
var _fetchGenres = require("./js/fetch/fetch-genres");
var _modalCard = require("./js/modal-card");
var _scrollToTop = require("./js/scroll/scroll-to-top");
var _modalInfo = require("./js/modal-info");
var _queue = require("./js/queue");
var _watched = require("./js/watched");
var _addToWatched = require("./js/add-to-watched");
var _teamModal = require("./js/team-modal");
...
// пошук жанрів по id
parcelHelpers.export(exports, "findGenreById", ()=>findGenreById);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _localStorageApi = require("../local-storage-api");
var _localStorageApiDefault = parcelHelpers.interopDefault(_localStorageApi);
...
async function getGenres() {
    ...
    const genres = await (0, _axiosDefault.default).get(url);
    return genres;
}
// збереження жанрів фильмів в локал
async function setGenresToLocalStorage() {
    await getGenres().then((result)=>{
        (0, _localStorageApiDefault.default).save("genres", result.data.genres);
    });
}
function findGenreById(listId) {
    const arrayGenres = (0, _localStorageApiDefault.default).load("genres");
    const textGenres = [];
...
},{"axios":"jo6P5","../local-storage-api":"kGcQy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kGcQy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const storageAPI = {
    save (key, value) {
...
var _displayFilms = require("./display-films");
var _viewTrailers = require("./view-trailers");
const refs = {
...
const closeEsc = (evt)=>{
    if (evt.key === "Escape") visibilityIsHidden();
};
// Закрывает модалку по клику в стороне
const closeClick = (evt)=>{
    if (evt.target === refs.modal) visibilityIsHidden();
};
function modalIsHidden(evt) {
    if (evt.currentTarget === evt.target || evt.target.classList.contains("please-js")) return;
...
function visibilityIsHidden() {
    ...
    (0, _viewTrailers.removeListenerTrailer)();
}

},{"./display-films":"6SStJ","./view-trailers":"7mCXx"}],"6SStJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveCurrentFilmsToLocal", ()=>saveCurrentFilmsToLocal);
parcelHelpers.export(exports, "getFilmFromLocal", ()=>getFilmFromLocal);
parcelHelpers.export(exports, "changeColorRating", ()=>changeColorRating);
var _localStorageApi = require("./local-storage-api");
var _localStorageApiDefault = parcelHelpers.interopDefault(_localStorageApi);
// зберігає переданий масив фильмів в локал
function saveCurrentFilmsToLocal(films) {
    (0, _localStorageApiDefault.default).save("display-films", films);
}
// повертає об'єкт фільму з картки з локалу
function getFilmFromLocal(evt) {
    if (evt.currentTarget === evt.target || evt.target.classList.contains("please-js")) return;
    const localFilms = (0, _localStorageApiDefault.default).load("display-films");
    ...
    (0, _localStorageApiDefault.default).save("currentFilm", currentFilm);
    return currentFilm;
}
...
function changeColorRating() {
    ...
    ratingAll.forEach((elem, index)=>{
        if (elem.textContent < 6) ratingAll[index].style.background = "#ff0000";
        if (elem.textContent >= 6 && elem.textContent < 7) ratingAll[index].style.background = "#ff6b08";
        if (elem.textContent >= 7) ratingAll[index].style.background = "#40c821";
    });
}

},{"./local-storage-api":"kGcQy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7mCXx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addListenerTrailer", ()=>addListenerTrailer) // =============================
 ...
 // }
;
parcelHelpers.export(exports, "removeListenerTrailer", ()=>removeListenerTrailer);
var _fetchTrailer = require("./fetch/fetch-trailer");
var _fetchTrailerDefault = parcelHelpers.interopDefault(_fetchTrailer);
const filmSerchAPI = new (0, _fetchTrailerDefault.default)();
let btnTrailer;
let posterFilm;
...
function clickBtnTrailer(evt) {
    ...
    backdropTrailer.addEventListener("click", backdrop, {
        capture: true
    });
...
function openTrailer(id) {
    filmSerchAPI.fetchTrailer(id).then((data)=>{
...
},{"./fetch/fetch-trailer":"eH7b3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eH7b3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
exports.default = PopFilmsAPI;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a6KaP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "scrollOnTop", ()=>scrollOnTop);
...
const btnVisibility = ()=>{
    if (window.scrollY > 400) scrollBtn.style.visibility = "visible";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lQFmh":[function(require,module,exports) {
var _displayFilms = require("./display-films");
var _fetchGenres = require("./fetch/fetch-genres");
var _queue = require("./queue");
var _addToWatched = require("./add-to-watched");
var _filmDefaultJpg = require("../images/film-default.jpg");
var _viewTrailers = require("./view-trailers");
...
function modalIsHidden(evt) {
    if (evt.currentTarget === evt.target || evt.target.classList.contains("please-js")) return;
    const film = (0, _displayFilms.getFilmFromLocal)(evt);
    const { poster_path , id , name , title , original_title , overview , popularity , genre_ids , vote_average , vote_count ,  } = film;
    refs.modalInfo.innerHTML = `
        <div class="modal__image-size">
          <img class="modal__image" src="${poster_path !== null ? BASE_IMAGES_URL + poster_path : _filmDefaultJpg}" alt="${title}" /><button type="button"  class="trailer__play-btn" data-id="${id}" aria-label="Trailer" id="trailerOpen"></button>
        </div>
        <div class="modal__container">
            ...
            <table class="modal-table">
                ...
                <tr>
                    ...
                    <td>${(0, _fetchGenres.findGenreById)(genre_ids)}</td>
                </tr>
            </table>
            ...
            `;
    (0, _queue.findBtnQueue)();
    (0, _addToWatched.findBtnWatched)();
    if ((0, _queue.filmNotQueue)()) (0, _queue.changeButtonForAdd)();
    else (0, _queue.changeButtonForRemove)();
    if ((0, _addToWatched.checkFilmInLocalStor)()) (0, _addToWatched.addBtnToWatched)();
    else (0, _addToWatched.addBtnRemoveWatched)();
    (0, _viewTrailers.addListenerTrailer)();
    (0, _displayFilms.changeColorRating)();
}

},{"./display-films":"6SStJ","./fetch/fetch-genres":"dioGm","./queue":"dGrI7","./add-to-watched":"fCB5m","../images/film-default.jpg":"7REEX","./view-trailers":"7mCXx"}],"dGrI7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// змінює колір та напис на кнопці в модалці щодо фильмів в черзі (ФИЛЬМ У ЧЕРЗІ)
parcelHelpers.export(exports, "changeButtonForRemove", ()=>changeButtonForRemove);
// змінює колір та напис на кнопці в модалці щодо фильмів в черзі (фильм НЕ у черзі)
parcelHelpers.export(exports, "changeButtonForAdd", ()=>changeButtonForAdd);
// відображає фильми, які є в бібліотеці
parcelHelpers.export(exports, "viewFilmLibrary", ()=>viewFilmLibrary);
// перевіряє чи немає фильму в черзі. Повертає "правда", якщо фільму немає
parcelHelpers.export(exports, "filmNotQueue", ()=>filmNotQueue);
// шукає кнопку QUEUE після рендеру модалки
parcelHelpers.export(exports, "findBtnQueue", ()=>findBtnQueue);
var _localStorageApi = require("./local-storage-api");
var _localStorageApiDefault = parcelHelpers.interopDefault(_localStorageApi);
var _displayFilms = require("./display-films");
var _filmCardsMarkup = require("./markup/film-cards-markup");
var _filmCardsMarkupDefault = parcelHelpers.interopDefault(_filmCardsMarkup);
var _clearMarkup = require("./markup/clear-markup");
let queueEl;
...
// вішаємо слухачів
try {
    filmContainer.addEventListener("click", (0, _displayFilms.getFilmFromLocal));
    try {
        filmLibrary.removeEventListener("click", (0, _displayFilms.getFilmFromLocal));
        viewQueue.removeEventListener("click", clickOnQueue);
    } catch (error) {}
} catch (error) {
    filmLibrary.addEventListener("click", (0, _displayFilms.getFilmFromLocal));
    viewQueue.addEventListener("click", clickOnQueue);
    try {
        filmContainer.removeEventListener("click", (0, _displayFilms.getFilmFromLocal));
    } catch (error) {}
    clickOnQueue();
}
...
function changeListQueue() {
    ...
    const actualFilm = (0, _localStorageApiDefault.default).load("currentFilm");
    let queueFilms = (0, _localStorageApiDefault.default).load("queueFilms");
    queueFilms = queueFilms ? queueFilms : [];
    if (isFilmNotInclude) {
        queueFilms.push(actualFilm);
        (0, _localStorageApiDefault.default).save("queueFilms", queueFilms);
        changeButtonForRemove();
    } else {
        const filmForRemove = queueFilms.findIndex((film)=>film.id === actualFilm.id);
        queueFilms.splice(filmForRemove, 1);
        (0, _localStorageApiDefault.default).save("queueFilms", queueFilms);
        changeButtonForAdd();
        try {
            if (viewQueue.classList.contains("btn-add__active")) viewFilmLibrary();
        } catch (error) {}
    }
}
function changeButtonForRemove() {
    if (queueEl.textContent === "add to queue") {
        queueEl.textContent = "remove from queue";
        queueEl.classList.add("btn-add__active");
    }
}
function changeButtonForAdd() {
    if (queueEl.textContent === "remove from queue") {
        queueEl.textContent = "add to queue";
        queueEl.classList.remove("btn-add__active");
    }
}
function viewFilmLibrary() {
    if (viewQueue.classList.contains("btn-add__active")) try {
        let queueFilms = (0, _localStorageApiDefault.default).load("queueFilms");
        if (queueFilms.length === 0) {
            (0, _clearMarkup.ifNotLibrary)();
            return;
        }
        (0, _displayFilms.saveCurrentFilmsToLocal)(queueFilms);
        filmLibrary.classList.remove("please-choose__empty");
        filmLibrary.innerHTML = (0, _filmCardsMarkupDefault.default).createFilmCardMarkup(queueFilms);
    } catch (error) {}
    if (viewWatched.classList.contains("btn-add__active")) try {
        let watchedFilms = (0, _localStorageApiDefault.default).load("watchedFilms");
        if (watchedFilms.length === 0) {
            (0, _clearMarkup.ifNotLibrary)();
            return;
        }
        (0, _displayFilms.saveCurrentFilmsToLocal)(watchedFilms);
        filmLibrary.classList.remove("please-choose__empty");
        filmLibrary.innerHTML = (0, _filmCardsMarkupDefault.default).createFilmCardMarkup(watchedFilms);
    } catch (error1) {}
}
function filmNotQueue() {
    const actualFilm = (0, _localStorageApiDefault.default).load("currentFilm");
    let queueFilms = (0, _localStorageApiDefault.default).load("queueFilms");
    queueFilms = queueFilms ? queueFilms : [];
    const isFilmNotInclude = queueFilms.find((film)=>film.id === actualFilm.id) === undefined;
...
function createFilmCardMarkup(film) {
    try {
        return film.map(({ poster_path , title , original_title , name , genre_ids , release_date , first_air_date , vote_average ,  })=>{
            return `<li class="film__card">
          <img class="film-card__image" src="${poster_path ? BASE_IMAGES_URL + poster_path : _filmDefaultJpg}" alt="${title || name}" loading="lazy" title="Click to enlarge"/>
          <div class="film-card__features-wrap">
            <p class="film-card__title">${noTitle(title, name, original_title)}</p>
            <div class="film-card__tech-wrap">
              <p class="film-card__features">${(0, _fetchGenres.findGenreById)(genre_ids)}</p><span class="film-card__features-mark"> |</span>
              <p class="film-card__date">${sliceFunction(release_date, first_air_date)}</p>
              <p class="film-card__rating">${Math.round(vote_average * 10) / 10}</p>
            </div>
          </div>
        </li>
        `;
        ...
        refs.notificationEl.textContent = "Sorry, something going wrong... Please try again.";
...
function noTitle(title, name, original_title) {
    if (!title && !name && original_title) return "no title";
...
},{"../fetch/fetch-genres":"dioGm","../../images/film-default.jpg":"7REEX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7REEX":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "film-default.8f1de243.jpg" + "?" + Date.now();
...
},{}],"dzXeo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "clearMurkup", ()=>clearMurkup);
// відображає в бібліотеці котика, якщо не вибрано жодного фильму
parcelHelpers.export(exports, "ifNotLibrary", ()=>ifNotLibrary);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCB5m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkFilmInLocalStor", ()=>checkFilmInLocalStor);
parcelHelpers.export(exports, "addBtnRemoveWatched", ()=>addBtnRemoveWatched);
parcelHelpers.export(exports, "addBtnToWatched", ()=>addBtnToWatched);
parcelHelpers.export(exports, "findBtnWatched", ()=>findBtnWatched);
var _localStorageApi = require("./local-storage-api");
var _localStorageApiDefault = parcelHelpers.interopDefault(_localStorageApi);
var _displayFilms = require("./display-films");
...
try {
    filmContainerRef.addEventListener("click", (0, _displayFilms.getFilmFromLocal));
} catch (error) {}
function checkFilmInLocalStor() {
    const newFilm = (0, _localStorageApiDefault.default).load("currentFilm");
    let watchedFilms = (0, _localStorageApiDefault.default).load("watchedFilms");
    watchedFilms = watchedFilms ? watchedFilms : [];
    const isFilmNotInclude = watchedFilms.find((film)=>film.id === newFilm.id) === undefined;
    return isFilmNotInclude;
}
function onClickBtnAddToWatched() {
    ...
    if (isFilmNotInclude) {
        ...
        (0, _localStorageApiDefault.default).save("watchedFilms", watchedFilms);
        addBtnRemoveWatched();
    } else {
        ...
        addBtnToWatched();
        try {
            if (watchedRef.classList.contains("btn-add__active")) (0, _watched.clickOnWatched)();
        } catch (error) {}
    }
}
...
function clickOnWatched() {
    ...
    (0, _queue.viewFilmLibrary)();
    (0, _displayFilms.changeColorRating)();
}

},{"./queue":"dGrI7","./display-films":"6SStJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7SYlg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function showConfetti() {
    (0, _canvasConfettiDefault.default).create(document.getElementById("canvas"), {
        resize: true,
        useWorker: true
    })({
        particleCount: 400,
...
const escClose = (e)=>{
    if (e.key === "Escape") addIsHidden();
};
const overlayClose = (e)=>{
    if (!e.target.closest(".modal-team")) addIsHidden();
};
...
},{"canvas-confetti":"cIEGq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cIEGq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toggleLoader", ()=>toggleLoader);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8QVU5":[function(require,module,exports) {
const headerContainer = document.querySelector(".header-home");
const sectionMain = document.querySelector(".section-main"); // const headerHeight = headerContainer.offsetHeight;
